...
{
    internal abstract class AbstractBackgroundWorkerVoidProgressFunc<T, TProgress> : BackgroundWorker
    {
        ...
        {
            synchronizationContext.Post(postCallback, new BackgroundWorkProgress<T, object, TProgress>(progress));
        }
